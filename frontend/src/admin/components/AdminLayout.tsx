...
import { LayoutDashboard, ShoppingCart, Users, FolderTree, LogOut, MessageSquare, Newspaper, Home as HomeIcon, Moon, Sun, Image as ImageIcon, BookOpen } from 'lucide-react';
import '../admin.css';
