...
export default function Login() {
  ...
  const [dismissRegisteredToast, setDismissRegisteredToast] = useState(false);
    ...
    <>
      ...
      <div className="auth-page">
        <div className="auth-container">
          ...
          {isJustRegistered && !dismissRegisteredToast && (
            <div className="auth-success-toast">
              <div className="toast-content">
                Registration successful. Please check your email to confirm your account.
              </div>
              <button className="toast-close" onClick={() => setDismissRegisteredToast(true)}>
                ×
              </button>
            </div>
          )}
